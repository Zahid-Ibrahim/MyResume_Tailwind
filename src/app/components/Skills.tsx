      ...
      <div className=" px-10 mt-32 mx-auto">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-20">
          ...
          <div className=" p-5 ">
            ...
            />
            <p className="text-white text-center mt-4">SQL Server</p>
          </div>
          {/* 1 ends  */}
          <div className="p-5">
            <img
              src="https://www.logolynx.com/images/logolynx/f5/f5eb0181378d683d84768d68f7fff4ff.png"
              className="w-20 h-20 object-contain  hover:-translate-y-2 hover:scale-110 duration-700"
            />
            <p className="text-white text-center mt-4">ASP.NET</p>
          </div>
          {/* 2 ends  */}
